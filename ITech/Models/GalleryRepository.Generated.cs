...
{   
	public partial class GalleryRepository
	{
		private IRepository<Gallery> _repository {get;set;}
		public IRepository<Gallery> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public GalleryRepository(IRepository<Gallery> repository, IUnitOfWork unitOfWork)
    	{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Gallery> All(string includes)
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Gallery> All(List<string> lstInclude)
		{
			return Repository.All(lstInclude);
		}

		/// <summary>
        /// Lấy đối tượng Gallery theo khóa chính
        /// </summary>        
      ...
      public Gallery GetById(int Id)
		{
		    try
			{
                 ...
                 return context.Galleries.FirstOrDefault(dk => dk.ID == Id);			
			 }
			 catch(Exception ex) 
            {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		 public Gallery SaveReturnToObject(Gallery obj)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;

                 context.Galleries.Add(obj);	
		...
		/// <summary>
        /// Thêm đối tượng Gallery vào database
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
		...
		/// <summary>
        /// Thực hiện commit phiên làm việc để thay đổi dữ liệu trong database liên quan đến đối tượng Gallery
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void AddRange(IEnumerable<Gallery> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void RemoveRange(IEnumerable<Gallery> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public Gallery FindByPK(params object[] keyValues)
        {
