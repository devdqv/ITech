...
{   
	...
	{
		private IRepository<Specification> _repository {get;set;}
		public IRepository<Specification> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public SpecificationRepository(IRepository<Specification> repository, IUnitOfWork unitOfWork)
    	{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Specification> All(string includes)
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Specification> All(List<string> lstInclude)
		{
			return Repository.All(lstInclude);
		}

		/// <summary>
        /// Lấy đối tượng Specification theo khóa chính
        /// </summary>        
      ...
      public Specification GetById(int Id)
		{
		    try
			{
                 ...
                 return context.Specifications.FirstOrDefault(dk => dk.ID == Id);			
			 }
			 catch(Exception ex) 
            {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		 public Specification SaveReturnToObject(Specification obj)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;
		...
		/// <summary>
        /// Thêm đối tượng Specification vào database
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
		...
		/// <summary>
        /// Thực hiện commit phiên làm việc để thay đổi dữ liệu trong database liên quan đến đối tượng Specification
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void AddRange(IEnumerable<Specification> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void RemoveRange(IEnumerable<Specification> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public Specification FindByPK(params object[] keyValues)
        {
