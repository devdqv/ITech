...
{   
	public partial class UserRepository
	{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<User> All(string includes)
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<User> All(List<string> lstInclude)
		{
      ...
      public User GetById(string Id)
		{
		    try
			{
                 ...
                 return context.Users.FirstOrDefault(dk => dk.ID == Id);			
			 }
			 catch(Exception ex) 
            {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		 public User SaveReturnToObject(User obj)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;
		...
		/// <summary>
        /// Thêm đối tượng User vào database
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
		...
		/// <summary>
        /// Thực hiện commit phiên làm việc để thay đổi dữ liệu trong database liên quan đến đối tượng User
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void AddRange(IEnumerable<User> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void RemoveRange(IEnumerable<User> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public User FindByPK(params object[] keyValues)
        {
