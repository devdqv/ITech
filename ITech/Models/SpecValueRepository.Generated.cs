...
{   
	...
	{
		private IRepository<SpecValue> _repository {get;set;}
		public IRepository<SpecValue> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public SpecValueRepository(IRepository<SpecValue> repository, IUnitOfWork unitOfWork)
    	{
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		public IQueryable<SpecValue> All()
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<SpecValue> All(string includes)
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<SpecValue> All(List<string> lstInclude)
		{
			return Repository.All(lstInclude);
		}

		/// <summary>
        /// Lấy đối tượng SpecValue theo khóa chính
        /// </summary>        
        ...
        /// VINHQD 10/3/2020
        /// </modified>
      public SpecValue GetById(int Id)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;
                 return context.SpecValues.FirstOrDefault(dk => dk.ID == Id);			
			 }
			 catch(Exception ex) 
            {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		 public SpecValue SaveReturnToObject(SpecValue obj)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;

                 context.SpecValues.Add(obj);	
		...
		/// <summary>
        /// Thêm đối tượng SpecValue vào database
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        /// </modified>
		public void Add(SpecValue entity)
		{
			Repository.Add(entity);
		}
		/// <summary>
        /// Xóa đối tượng SpecValue
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        /// </modified>
		public void Delete(SpecValue entity)
		{
			Repository.Delete(entity);
		}
		/// <summary>
        /// Thực hiện commit phiên làm việc để thay đổi dữ liệu trong database liên quan đến đối tượng SpecValue
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void AddRange(IEnumerable<SpecValue> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void RemoveRange(IEnumerable<SpecValue> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public SpecValue FindByPK(params object[] keyValues)
        {
