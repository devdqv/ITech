...
{   
	...
	{
		private IRepository<Comment> _repository {get;set;}
		...
		public CommentRepository(IRepository<Comment> repository, IUnitOfWork unitOfWork)
    	{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Comment> All(string includes)
		{
        ...
        /// VINHQD 10/3
        /// </modified>
		public IQueryable<Comment> All(List<string> lstInclude)
		{
			return Repository.All(lstInclude);
		}

		/// <summary>
        /// Lấy đối tượng Comment theo khóa chính
        /// </summary>        
      ...
      public Comment GetById(int Id)
		{
		    try
			{
                 ...
                 return context.Comments.FirstOrDefault(dk => dk.ID == Id);			
			 }
			 catch(Exception ex) 
            {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
		 public Comment SaveReturnToObject(Comment obj)
		{
		    try
			{
		         ITechEntities context = (ITechEntities)Repository.UnitOfWork.Context;
		...
		/// <summary>
        /// Thêm đối tượng Comment vào database
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
		...
		/// <summary>
        /// Thực hiện commit phiên làm việc để thay đổi dữ liệu trong database liên quan đến đối tượng Comment
        /// </summary>
        /// <modified>
        /// Author              Date                comments
        /// VINHQD 10/3/2020
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void AddRange(IEnumerable<Comment> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public void RemoveRange(IEnumerable<Comment> list)
        {
        ...
        /// VINHQD 10/3/2020
        /// </modified>
        public Comment FindByPK(params object[] keyValues)
        {
